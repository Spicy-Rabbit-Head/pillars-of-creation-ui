...
import { boundRange, multipleFixed } from '@/common/utils'
import { ScrollbarExposed } from '@/components'
...
onMounted(() => {
  ...
  barLength.value = boundRange((pane.value.offsetHeight / (pane.value.scrollHeight || 1)) * 100, 5, 99)
})
...
<template>
  <div class="wrapper">
    ...
    <poc-scrollbar ref="bar" :bar-length="barLength" @scroll="handleBarScroll"></poc-scrollbar>
  </div>
</template>
